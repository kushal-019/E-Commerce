...
const UpdateProductPage = () => {
    ...
    const getSingleProduct=async()=>{
        ...
        try {
            const currPro = await getDoc(doc(firestore , 'products' , id));  
            const currProData = currPro.data();
            
            setProduct({
                title: currProData?.title,
                price: currProData?.price,
                productImageUrl: currProData?.productImageUrl,
                category: currProData?.category,
                description: currProData?.description,
                quantity : currProData?.quantity,
                time: Timestamp.now(),
                date: new Date().toLocaleString(
                    "en-US",
                    {
